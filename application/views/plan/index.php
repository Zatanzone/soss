...
<?php
	if (count ( $task ) == 0) { 
		...
		foreach ( $task as $r ) {
			...
			echo "<td width='15%'>" . form_input(array('name'=>'edits[]','id'=>'editstartdate','value'=>$r ['STARTDATE'],'size'=>'10','style'=>' float: left;')). "</td>";
			echo "<td width='15%'>" . form_input(array('name'=>'edite[]','id'=>'editenddate','value'=>$r ['ENDDATE'],'size'=>'10','style'=>' float: left;')) . "</td>";
			echo "<td width='10%'>" . form_input(array('name'=>'progress','value'=>$r ['PROGRESS'],'size'=>5)) ."</td>";
        		 			  ...
        		 			  success: function(res){
        		 				if(res==0){
										...
										$("#editstartdate[]").val('');
					          		 		 ...
					          		 		 */			 		
            		$("#editstartdate[]").datepicker( "option", "dateFormat", $dateformat );    		 	            		 	
